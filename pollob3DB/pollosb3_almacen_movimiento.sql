...
--
-- Table structure for table `almacen_movimiento`
--

DROP TABLE IF EXISTS `almacen_movimiento`;
...
CREATE TABLE `almacen_movimiento` (
  ...
  CONSTRAINT `almacen_movimiento_ibfk_1` FOREIGN KEY (`insumo_id`) REFERENCES `insumo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `almacen_movimiento`
--

LOCK TABLES `almacen_movimiento` WRITE;
